...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    new_score = score + brawl_points

    # Points from Sus Fuss (if applicable)
    sus_points_added = sus_points(new_score) - new_score

    # Total gain from rolling 0
    total_gain = brawl_points + sus_points_added
